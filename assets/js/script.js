...
function createButton(buttonTypeClass, buttonTeks, eventListener, btnRemove) {
  ...
  if (btnRemove) {
    button.addEventListener("click", function (event) {
      const confirmDelete = confirm("Apakah Anda yakin ingin menghapus buku dari daftar?");
      if (confirmDelete) {
        eventListener(event);
      }
    });
...
function createCheckButton() {
  return createButton("cyan", "Selesai dibaca", function (event) {
...
function createUndoButton() {
  return createButton("cyan", "Belum selesai dibaca", function (event) {
